...
import com.learn.rxjava3.android.examples.utils.AppConstant
...
class ZipExampleActivity : AppCompatActivity() {
    ...
    private fun doSomeWork() {
        Observable.zip(getCricketFansObservable(), getFootballFansObservable(),getCricketFansObservable(),
            Function3<List<User>, List<User>, List<User>,List<User>> { cricketFans, footballFans,cricketFans2 ->
                return@Function3 Utils.filterUserWhoLovesBoth(cricketFans, footballFans)
            })
